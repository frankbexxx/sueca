      ...
      <div className="landing-content">
        <div className="landing-card">
              ...
              <div className="landing-media">
                <div className="landing-media-frame">
                  ...
                  <div className="landing-media-placeholder" style={{ display: 'none' }}>
                    <span className="landing-media-label">capa / animação</span>
                    <span className="landing-media-format">jpg · png · gif</span>
                  </div>
                </div>
              </div>
          ...
          <footer className="landing-footer">
            <div className="landing-small-print">{t.landing.credits}</div>
            <div className="landing-copyright">{t.landing.copyright}</div>
          </footer>
        </div>
      </div>
    </div>
