...
- SUECÂO multi-jogos: Sueca + Spades + Hearts + King no selector; sessão via `GameAdapter` (E1–E5)
- Play Store track: Capacitor config, backend v1 (`backend/`), legal pages, prompts P0–P8, SVG card placeholders (`docs/ASSETS.md`)
